...
![Terracotta Army, Pit 1 (scaled preview)](https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/Terracotta_Army%2C_View_of_Pit_1.jpg/500px-Terracotta_Army%2C_View_of_Pit_1.jpg)  
...
```mermaid
flowchart TB
  subgraph Han["Han administrative idiom"]
    A["如律令 — as under statute / ordinance"]
    B["急急 — urgently; at once"]
  end
  subgraph Slip["Document strip context (type of evidence)"]
    C["Dispatch-style orders<br/>e.g. 發夫討畔羌 … 急急如律令"]
  end
  subgraph Dao["Religious reuse"]
    D["Han-era ritual culture<br/>e.g. Celestial Masters transmission stories"]
    E["Talisman / spell endings<br/>太上老君急急如律令"]
  end
  subgraph Folk["Folk overlay (optional reading)"]
    F["律令 as spirit-name<br/>Thunder-department 'speed' lore"]
  end
  A --> C
  B --> C
  C --> D
  D --> E
  F -. "homophony + imagery" .-> E
```
...
![Hand-copied Taoist / folk charm manual (two pages; 敕令-style heading and stylized 符)](http://k.sinaimg.cn/n/sinacn10120/102/w552h350/20191106/1bf4-ihyxcrq0238107.jpg/w700d1q75cms.jpg?by=cms_fixed_width)  
...
![Daoist numismatic charm with Daoist “magic writing” (historical illustration, scaled preview)](https://upload.wikimedia.org/wikipedia/commons/thumb/0/02/Taoist_numismatic_charms_with_Taoist_magic_writing_from_the_Qin_Ding_Qian_Lu_02.jpg/500px-Taoist_numismatic_charms_with_Taoist_magic_writing_from_the_Qin_Ding_Qian_Lu_02.jpg)  
...
![Eight Trigrams 八卦 — eight trigrams, compass-style diagram (preview)](https://upload.wikimedia.org/wikipedia/commons/thumb/e/e9/Bagua_trigrams.svg/500px-Bagua_trigrams.svg.png)  
...
![Yin–yang symbol (scaled preview)](https://upload.wikimedia.org/wikipedia/commons/thumb/1/17/Yin_yang.svg/500px-Yin_yang.svg.png)  
...
![Wuxing cycle (scaled preview)](https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Wu_Xing.png/500px-Wu_Xing.png)  
...
![Mawangdui silk manuscripts (exhibit, scaled preview)](https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Mawangdui_Silk_Texts_2.JPG/500px-Mawangdui_Silk_Texts_2.JPG)  
...
![Daoyin tu reconstruction (scaled preview)](https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Daoyin_tu_-_chart_for_leading_and_guiding_people_in_exercise_Wellcome_L0036007.jpg/500px-Daoyin_tu_-_chart_for_leading_and_guiding_people_in_exercise_Wellcome_L0036007.jpg)  
...
- **Historical Taoism:** **Pangu** lore is **Chinese myth and cosmology**, **not** a **Laozi–Zhuangzi** specialty. Later **Taoist encyclopedias** and **local cults** could **absorb** such figures, but **Pangu** is **not** “**the** Taoist god” in any **single** orthodox sense.
...
| **Pangu** (盤古 *pun4 gu2*) | **Cosmogonic** giant in **Chinese myth**; namesake for manga **Banko**. **Appendix C**. |
